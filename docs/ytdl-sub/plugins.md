[Skip to main content](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html#main-content)
...
- [.rst](https://ytdl-sub.readthedocs.io/en/latest/_sources/config_reference/plugins.rst)
- .pdf
...
# Plugins [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#plugins "Link to this heading")

## audio\_extract [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#audio-extract "Link to this heading")
...
## chapters [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#chapters "Link to this heading")
...
“intro”, “outro”, “selfpromo”, “preview”, “filler”, “interaction”, “music\_offtopic”,\
“poi\_highlight”, or “all” to include all categories.\
\
* * *\
\
## date\_range [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#date-range "Link to this heading")\
\
...
* * *\
\
## download [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#download "Link to this heading")\
\
...
* * *\
\
## embed\_thumbnail [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#embed-thumbnail "Link to this heading")\
\
...
* * *\
\
## file\_convert [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#file-convert "Link to this heading")\
\
...
* * *\
\
## filter\_exclude [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#filter-exclude "Link to this heading")\
\
...
* * *\
\
## filter\_include [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#filter-include "Link to this heading")\
\
...
* * *\
\
## format [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#format "Link to this heading")\
\
...
* * *\
\
## match\_filters [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#match-filters "Link to this heading")\
\
...
* * *\
\
## music\_tags [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#music-tags "Link to this heading")\
\
Adds tags to every download audio file using\
[MediaFile](https://mediafile.readthedocs.io/en/latest/),\
...
[source code](https://github.com/beetbox/mediafile/blob/v0.9.0/mediafile.py#L1770).\
\
...
* * *\
\
## nfo\_tags [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#nfo-tags "Link to this heading")\
\
...
description:\
\
Tags within the nfo\_root tag. In the usage above, it would look like\
\
```\
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\
<episodedetails>\
...
* * *\
\
## output\_directory\_nfo\_tags [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#output-directory-nfo-tags "Link to this heading")\
\
...
* * *\
\
## output\_options [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#output-options "Link to this heading")\
\
...
perform evaluation for keep\_files\_before/after and keep\_max\_files. Defaults\
to the entry’s upload\_date\_standardized variable.\
\
`keep_max_files`\
\
expected type:\
...
When True, sets the file’s mtime to match the video’s upload\_date from\
...
* * *\
\
## overrides [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#overrides "Link to this heading")\
\
...
* * *\
\
## split\_by\_chapters [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#split-by-chapters "Link to this heading")\
\
...
* * *\
\
## square\_thumbnail [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#square-thumbnail "Link to this heading")\
\
...
* * *\
\
## static\_nfo\_tags [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#static-nfo-tags "Link to this heading")\
\
...
* * *\
\
## subtitles [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#subtitles "Link to this heading")\
\
...
* * *\
\
## throttle\_protection [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#throttle-protection "Link to this heading")\
\
...
* * *\
\
## video\_tags [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#video-tags "Link to this heading")\
\
...
* * *\
\
## ytdl\_options [\#](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html\#ytdl-options "Link to this heading")\
\
...
[this docstring](https://github.com/yt-dlp/yt-dlp/blob/2022.04.08/yt_dlp/YoutubeDL.py#L197)\
for more details.\
\
Usage:\
\
...
Copy to clipboard\
\
where each key is a ytdl argument. Include in the example are some popular ytdl\_options.\
\
Contents\
\
\
Versions**[latest](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html)**[v0.2.0](https://ytdl-sub.readthedocs.io/en/v0.2.0/config_reference/plugins.html)On Read the Docs[Project Home](https://app.readthedocs.org/projects/ytdl-sub/?utm_source=ytdl-sub&utm_content=flyout)[Builds](https://app.readthedocs.org/projects/ytdl-sub/builds/?utm_source=ytdl-sub&utm_content=flyout)Search\
\
* * *\
\
