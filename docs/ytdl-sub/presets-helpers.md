[Skip to main content](https://ytdl-sub.readthedocs.io/en/latest/prebuilt_presets/helpers.html#main-content)
...
- [.rst](https://ytdl-sub.readthedocs.io/en/latest/_sources/prebuilt_presets/helpers.rst)
- .pdf
...
See how to apply helper presets [here](https://ytdl-sub.readthedocs.io/en/latest/prebuilt_presets/index.html)
...
This preset is primarily a sensible default configuration of [the\\
‘throttle\_protection’ plugin](https://ytdl-sub.readthedocs.io/en/latest/config_reference/plugins.html#throttle-protection) along with
...
around this kind of throttling, this preset includes [an assertion](https://ytdl-sub.readthedocs.io/en/latest/config_reference/scripting/scripting_functions.html#error-functions) that will stop
...
_Sibling_ refers to any entry within the same _playlist_. For channel downloads, this would
imply **every** video that gets downloaded since yt-dlp treats the channel as the _playlist_.
